...
func ExampleCtrl_PrepareDeploymentOfEmptyLane() {
	...
	//output:
	//{"id":"","executable":false,"xml_raw":"","xml":"","svg":"\u003csvg/\u003e","name":"Lane_Timer_FJ","elements":null,"lanes":[{"order":0,"lane":{"label":"Lane_Timer_fj","bpmn_element_id":"Lane_Timer_fj","device_descriptions":null,"selectables":[],"selection":null,"elements":[{"order":0,"time_event":{"bpmn_element_id":"IntermediateThrowEvent_1opksgz","kind":"timeDuration","time":"","label":"IntermediateThrowEvent_1opksgz"}}]}}]}
