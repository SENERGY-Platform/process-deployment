...
func ExampleIgnoredPredefinedEventBpmnToDeployment() {
	...
	//output:
	//<nil> {"id":"","xml_raw":"","xml":"","svg":"","name":"ignore_msg_event","elements":[{"order":0,"msg_event":{"label":"IntermediateThrowEvent_1277ux9","bpmn_element_id":"IntermediateThrowEvent_1277ux9","device":{"id":"","local_id":"","name":"","device_type_id":""},"service":{"id":"","local_id":"","name":"","description":"","aspects":null,"protocol_id":"","inputs":null,"outputs":null,"functions":null,"rdf_type":""},"path":"","value":"","operation":"","event_id":""}}],"lanes":null}
}
...
func ExampleLanesBpmnDeploymentToXml() {
	...
	//             <bpmn:extensionElements>
	//                 <camunda:inputOutput>
	//                     <camunda:inputParameter name="payload">{"function":{"id":"fid","name":"","concept_id":"","rdf_type":""},"characteristic_id":"example_hex","device":{"id":"device_1","local_id":"","name":"","device_type_id":""},"service":{"id":"service_1","local_id":"","name":"","description":"","aspects":null,"protocol_id":"pid","inputs":null,"outputs":null,"functions":null,"rdf_type":""},"protocol":{"id":"pid","name":"protocol1","handler":"p","protocol_segments":null},"input":"000"}</camunda:inputParameter>
	...
	//             <bpmn:extensionElements>
	//                 <camunda:inputOutput>
	//                     <camunda:inputParameter name="payload">{"function":{"id":"fid1","name":"","concept_id":"","rdf_type":""},"characteristic_id":"example_hex","device":{"id":"device_2","local_id":"","name":"","device_type_id":""},"service":{"id":"service_1","local_id":"","name":"","description":"","aspects":null,"protocol_id":"pid","inputs":null,"outputs":null,"functions":null,"rdf_type":""},"protocol":{"id":"pid","name":"protocol1","handler":"p","protocol_segments":null},"input":"000"}</camunda:inputParameter>
	//                     <camunda:inputParameter name="input">"fff"</camunda:inputParameter>
	//                 </camunda:inputOutput>
	//             </bpmn:extensionElements>
	...
	//             <bpmn:extensionElements>
	//                 <camunda:inputOutput>
	//                     <camunda:inputParameter name="payload">{"function":{"id":"fid2","name":"","concept_id":"","rdf_type":""},"characteristic_id":"example_hex","device":{"id":"device_2","local_id":"","name":"","device_type_id":""},"service":{"id":"service_2","local_id":"","name":"","description":"","aspects":null,"protocol_id":"pid","inputs":null,"outputs":null,"functions":null,"rdf_type":""},"protocol":{"id":"pid","name":"protocol1","handler":"p","protocol_segments":null},"input":"000"}</camunda:inputParameter>
	//                     <camunda:inputParameter name="input">"fff"</camunda:inputParameter>
	//                 </camunda:inputOutput>
	//             </bpmn:extensionElements>
